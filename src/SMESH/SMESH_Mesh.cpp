...
void SMESH_Mesh::ExportSTL(const char *file, const bool isascii)
{
  Unexpect aCatch(SalomeException);
...
int SMESH_Mesh::NbEdges(SMDSAbs_ElementOrder order)
{
  Unexpect aCatch(SalomeException);
...
int SMESH_Mesh::NbFaces(SMDSAbs_ElementOrder order)
{
  Unexpect aCatch(SalomeException);
...
int SMESH_Mesh::NbTriangles(SMDSAbs_ElementOrder order)
{
  Unexpect aCatch(SalomeException);
...
int SMESH_Mesh::NbQuadrangles(SMDSAbs_ElementOrder order)
{
  Unexpect aCatch(SalomeException);
...
int SMESH_Mesh::NbVolumes(SMDSAbs_ElementOrder order)
{
  Unexpect aCatch(SalomeException);
...
int SMESH_Mesh::NbTetras(SMDSAbs_ElementOrder order)
{
  Unexpect aCatch(SalomeException);
...
int SMESH_Mesh::NbHexas(SMDSAbs_ElementOrder order)
{
  Unexpect aCatch(SalomeException);
...
int SMESH_Mesh::NbPyramids(SMDSAbs_ElementOrder order)
{
  Unexpect aCatch(SalomeException);
...
int SMESH_Mesh::NbPrisms(SMDSAbs_ElementOrder order)
{
  Unexpect aCatch(SalomeException);
